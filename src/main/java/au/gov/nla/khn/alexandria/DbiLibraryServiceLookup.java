 ...
 */
@Service
public class DbiLibraryServiceLookup implements LibraryServiceLookup {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(DbiLibraryServiceLookup.class);

	private final IDBI DBI;
	
	public DbiLibraryServiceLookup() {
		...
		ResourceLoader rl = new ClassRelativeResourceLoader(DbiLibraryServiceLookup.class);
